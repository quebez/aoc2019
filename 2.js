...
/************* FIRST TASK *************/
let first = (arr, a = 12, b = 2) => {
  arr[1] = a;
  arr[2] = b;

  return intcode(arr)[0];
}
...
/* OUT */
let f = first(input.slice());
let s = second(input.slice());

console.log(`First answer: ${f} ${6087827 == f}.`);
console.log(`Second answer: ${s} ${5379 == s}.`);

/*
Text:
Advent of Code[About][Events][Shop][Settings][Log Out]quebez 4*
